...
function display()
{
  ...
  print "<td width='20%'>We find these peers...<i class='far fa-user-circle'></i></td><td width='20%'>On these fields...<i class='fas fa-flask'></i></td><td width='30%'>At these levels<i class='far fa-share-square'></i></td><td width='30%'>You may contact them through...<i class='fas fa-envelope'></i></td> \n";
  print "</tr> \n";
